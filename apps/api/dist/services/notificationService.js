...
class NotificationService {
    ...
    static async sendNotification(options) {
        try {
            ...
            const emailSent = await emailService_1.default.sendEmail({
    ...
    static async sendBulkNotifications(userIds, options) {
        let successCount = 0;
    ...
    static generateEmailHTML(options, userName) {
        const colors = {
            ASSIGNMENT: '#007bff',
            GRADE: '#28a745',
            ANNOUNCEMENT: '#fd7e14',
