...
router.post('/', auth_1.protect, (0, auth_1.authorize)(database_2.Role.TEACHER, database_2.Role.ADMIN, database_2.Role.SCHOOL_ADMIN), (0, auth_1.requirePermission)('files.write'), upload.single('file'), async (req, res) => {
    try {
        if (!req.file) {
...
router.delete('/:id', auth_1.protect, (0, auth_1.authorize)(database_2.Role.TEACHER, database_2.Role.ADMIN, database_2.Role.SCHOOL_ADMIN), (0, auth_1.requirePermission)('files.delete'), async (req, res) => {
    const { id } = req.params;
    try {
