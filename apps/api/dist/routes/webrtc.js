...
function handleWebRTCSignaling(io) {
    io.of('/webrtc').use((socket, next) => {
...
router.post('/rooms', auth_1.protect, async (req, res) => {
...
router.get('/rooms/:roomId', auth_1.protect, async (req, res) => {
