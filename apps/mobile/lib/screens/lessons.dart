      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.pushNamed(context, '/create-lesson').then((_) {
                _loadLessons();
              });
            },
          ),
              ...
              children: [
                Expanded(
                  child: OutlinedButton.icon(
                    onPressed: () {
                      // Check if the class is actually live
                      final bool isLive =
                          lesson['isLive'] == true ||
                          lesson['status'] == 'live';
                      ...
                      if (isLive) {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) => LiveClassScreen(
                              lessonTitle: lesson['title'] ?? 'Live Class',
                              teacherName: lesson['teacher'] ?? 'Instructor',
                            ),
                          ),
                        );
                      } else {
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text(
                              'This class is not currently live. Please check the schedule.',
                            ),
